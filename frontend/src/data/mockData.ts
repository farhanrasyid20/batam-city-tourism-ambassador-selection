...
export const stageCriteriaMap: Record<string, CriteriaItem[]> = {
  ...
  "Pre Camp": [
    { key: "preCampAdministrationCompleteness", label: "Kelengkapan Administrasi", weight: 10 },
    { key: "preCampEssayMotivation", label: "Esai/Motivasi Mengikuti Pemilihan", weight: 15 },
    { key: "preCampBatamKnowledge", label: "Pengetahuan Dasar Batam & Kepri", weight: 20 },
    { key: "preCampCommunicationPublicSpeaking", label: "Komunikasi & Public Speaking Awal", weight: 20 },
    { key: "preCampEthicsPersonalityAppearance", label: "Etika, Kepribadian & Penampilan", weight: 15 },
    { key: "preCampDigitalLiteracy", label: "Literasi Digital & Media Sosial", weight: 10 },
    { key: "preCampCommitmentDiscipline", label: "Komitmen & Kedisiplinan Awal", weight: 10 },
  ],
  Camp: [
    { key: "campDisciplinePunctuality", label: "Kedisiplinan & Kehadiran", weight: 10 },
    { key: "campAttitudeEthics", label: "Sikap, Etika & Kerja Sama", weight: 15 },
    { key: "campTourismCultureKnowledge", label: "Pengetahuan Pariwisata & Budaya", weight: 20 },
    { key: "campPublicSpeakingStorytelling", label: "Public Speaking & Storytelling", weight: 20 },
    { key: "campForeignLanguage", label: "Kemampuan Bahasa Asing", weight: 10 },
    { key: "campTalentCreativity", label: "Bakat/Unjuk Kreativitas", weight: 10 },
    { key: "campPersonalBrandingContent", label: "Personal Branding & Konten Digital", weight: 10 },
    { key: "campProblemSolving", label: "Problem Solving & Critical Thinking", weight: 5 },
  ],
  "Grand Final": [
    { key: "grandFinalAppearanceConfidence", label: "Penampilan & Kepercayaan Diri", weight: 30 },
    { key: "grandFinalCultureTourismKnowledge", label: "Pengetahuan Umum, Kebudayaan, dan Pariwisata Kota Batam", weight: 40 },
    { key: "grandFinalPublicSpeaking", label: "Public Speaking", weight: 30 },
  ],
};
