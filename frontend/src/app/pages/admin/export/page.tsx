...
export default function AdminExportPage() {
  ...
  }, [recap?.meta.max_judges, selectedStage]);
  ...
  const workbookSheets = useMemo<WorkbookSheet[]>(() => {
    ...
    const buildStageSheet = (stage: "Audition" | "Camp" | "Grand Final"): WorkbookSheet => {
      ...
      return {
        ...
        headers: ["Rank", "No Urut", "Nama", "Kategori", ...judgeHeaders, "Total", "Rata-rata"],
        rows: sheetRows,
      };
    };
              ...
              <tbody>
                {tableData.map((row, index) => {
                  ...
                  const baseCells = [
                    ...
                    <td key="number" className="px-3 py-2.5" style={{ color: "#888" }}>
                      {row.participant_number}
                    </td>,
                    <td
                      key="name"
